...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="col intro py-1" style="background-color : #ace7ef;">
              <div class="row-sm-12 row-md img text-center">
                <img src="img/MYBANK.png" class="img-fluid pt-2">
              </div>
              <div class="row-sm-12 row-md">
      ...
      <footer class="text-center mt-5 py-2">
        <p>Our Bank to Fulfill Your Dreams</p>
      </footer>
